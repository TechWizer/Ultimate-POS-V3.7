...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    Route::post('/products/get_variation_temp_values', 'ProductController@getVariationTemplateValues');
    ...
    Route::get('products/get-product-variations/{product_id}', 'ProductController@getProductVariationsForCostCodeAndSellCode');
    Route::patch('products/product-variations-code/update', 'ProductController@productCostCodeAndSellCodeUpdate');
    ...
    Route::get('/sells/pos/get-customer-coin-points', 'SellPosController@getCustomerCoinPoints');
    ...
    Route::get('products/add-purchase-line-qty-to/variation-location-details-qty-available', 
    'ImportOpeningStockController@updatePurchaseLinesQuantityToVariationLocationDetailsQuantityAvailable');
    ...
    Route::get('/purchase-return/get/suppliers/purchase-invoice/{supplier_id}', 'PurchaseReturnController@getSuppliersPurchaseInvoices');
    Route::get('/purchase-return/get/purchases', 'PurchaseReturnController@getPurchaseRows');
...
//        bulk payment
    ...
    //    serial key create
    Route::get('serials', 'SerialController@index')->name('serials');
    Route::get('products/{product_id}/{qty}/{row_id}/serial-create', 'SerialController@create')->name('serial-create');
    Route::post('products/{product_id}/serial-store', 'SerialController@store')->name('serial-store');
    Route::get('purchases/serials/{purchase_line_id}/show', 'SerialController@show')->name('purchased-serial-show');
    Route::get('pos/serials/{transaction_sell_line_id}/show', 'SerialController@show')->name('sold-serial-show');
//    serial sell
    Route::get('products/{product_id}/{qty}/{row_id}/serial-sell-create', 'SerialController@sellCreate')->name('serial-sell-create');
    Route::post('products/{product_id}/get/{serial_number}', 'SerialController@getSerialNumber')->name('get-serial-number');
    Route::post('products/check/{serial_number}', 'SerialController@checkSerialNumber')->name('check-serial-number');
