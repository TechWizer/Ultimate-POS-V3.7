          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                {!! Form::select("account_id", $accounts, !empty($payment_line->cheque) ? $payment_line->cheque->account_id : $payment_line->account_id , ['class' => 'form-control select2', 'id' => "account_id", 'style' => 'width:100%;']); !!}
              </div>
            </div>
          </div>
        @endif
