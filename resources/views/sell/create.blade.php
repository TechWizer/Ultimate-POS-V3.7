		...
		<div class="col-md-12 col-sm-12">
			...
			@component('components.widget', ['class' => 'box-primary'])
				...
				<div class="col-md-12 well well-sm bg-light-gray @if(empty($pos_settings['enable_coin_points'])) hide @endif">
					...
					@endif
			    	<input type="hidden" name="coin_points_earned_amount" id="coin_points_earned_amount" value="0">
			    	<input type="hidden" name="coin_points_redeemed_amount" id="coin_points_redeemed_amount" value="0">
			    	{{-- <div class="col-md-12"><h4>{{session('business.rp_name')}}</h4></div> --}}
			    	<div class="col-md-4">
				        <div class="form-group">
				            ...
				            <div class="input-group">
				                ...
				                {!! Form::number('coin_points_redeemed_amount_modal', 0, ['class' => 'form-control direct_sell_coin_points_input', 'data-max_points' => 0]); !!}
				                {{-- <input type="hidden" id="rp_name" value="{{session('business.rp_name')}}"> --}}
				            </div>
				        </div>
				    </div>
				    <div class="col-md-4">
				    	<p><strong>@lang('lang_v1.available_coin_points'):</strong> <span id="available_coin_points">0</span></p>
				    </div>
			    </div>
