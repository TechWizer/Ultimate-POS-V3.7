        ...
        <table class="table bg-gray">
          ...
          @foreach($purchase->purchase_lines as $purchase_line)
            <tr>
              ...
              <td><span class="display_currency" data-is_quantity="true" data-currency_symbol="false">{{ $purchase_line->free_issues }}</span> @if(!empty($purchase_line->sub_unit)) {{$purchase_line->sub_unit->short_name}} @else {{$purchase_line->product->unit->short_name}} @endif</td>
