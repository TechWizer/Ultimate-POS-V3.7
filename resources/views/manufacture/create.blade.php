<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    {!! Form::open(['url' => action('ManufactureController@store'), 'method' => 'post', 'id' => $quick_add ? 'quick_add_brand_form' : 'manufacture_add_form' ]) !!}
    ...
    <div class="modal-body">
      <div class="form-group">
        {!! Form::label('name','Manufacture Name :*') !!}
          {!! Form::text('name', null, ['class' => 'form-control', 'required', 'placeholder' => 'Manufacture Name' ]); !!}
      </div>
