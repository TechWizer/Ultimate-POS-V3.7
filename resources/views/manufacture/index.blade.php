...
<section class="content-header">
    <h1>Manufactures
        <small>Manage your manufactures</small>
    </h1>
    <!-- <ol class="breadcrumb">
...
<section class="content">
    @component('components.widget', ['class' => 'box-primary', 'title' => 'All your Manufactures'])
        @can('brand.create')
            @slot('tool')
                <div class="box-tools">
                    <button type="button" class="btn btn-block btn-primary btn-modal" 
                        data-href="{{action('ManufactureController@create')}}" 
...
@section('javascript')
    ...
    $(document).on('click', 'button.delete_manufacture_button', function() {
        swal({
            title: LANG.sure,
            text: "This Manufacture will delete",
            icon: 'warning',
            buttons: true,
            dangerMode: true,
        }).then(willDelete => {
