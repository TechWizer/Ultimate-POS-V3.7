                ...
                <div class="col-sm-8 col-sm-offset-2">
                    <div class="form-group">
                        <div class="">
                            ...
                            <select class="select2 form-control mb-3 select2-multiple" multiple="multiple" 
								data-placeholder="Select Purchase Invoices" name="purchase_invoice_ids[]" 
								id="purchase_invoice_ids" style="width: 100%; height:36px;">
                            </select>
                        </div><!-- end col -->
                    </div>
                </div>
