...
{!! Form::open(['url' => action('ProductController@update' , [$product->id] ), 'method' => 'PUT', 'id' => 'product_add_form',
    ...
    @component('components.widget', ['class' => 'box-primary'])
        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    {!! Form::label('second_name', __('product.product_name_si') . ':*') !!}
                    {!! Form::text('second_name', $product->second_name, ['class' => 'form-control',
                    'placeholder' => __('product.product_name_si')]); !!}
                </div>
            </div>
            ...
            <div class="col-sm-4">
              <div class="form-group">
                {!! Form::label('manufacture_id', 'Manufacture :') !!}
                  {!! Form::select('manufacture_id', $manufactures, $product->manufacture_id, ['placeholder' => __('messages.please_select'), 'class' => 'form-control select2']); !!}
              </div>
            </div>
            <div class="col-sm-4">
              <div class="form-group">
                {!! Form::label('type_id', 'Vehicle Type :') !!}
                  {!! Form::select('type_id', $types, $product->type_id, ['placeholder' => __('messages.please_select'), 'class' => 'form-control select2']); !!}
              </div>
            </div>
            <div class="col-sm-4">
              <div class="form-group">
                {!! Form::label('vehicle_model_id', 'Vehicle Model :') !!}
                  {!! Form::select('vehicle_model_id', $models, $product->vehicle_model_id, ['placeholder' => __('messages.please_select'), 'class' => 'form-control select2']); !!}
              </div>
            </div>
            <div class="col-sm-4">
              <div class="form-group">
        ...
        <div class="row">
            <div class="col-md-10">
                <table class="table table-bordered">
                    ...
                    @forelse($product_quantity_discount_prices as $product_quantity_discount_price)
                        <tr>
                            <td>{{ $loop->iteration }}.</td>
                            <td>
                                <div class="form-group">
                                    <input type="text" class="form-control" name="prices[{{ $loop->index }}][quantity]" value="{{ $product_quantity_discount_price->quantity_limit }}">
                                </div>
                            </td>
                            <td>
                                <div class="form-group">
                                    <input type="text" class="form-control" name="prices[{{ $loop->index }}][price]" value="{{ $product_quantity_discount_price->price }}">
                                </div>
                            </td>
                        </tr>
                        @if($loop->last && $loop->index == 0)
                            <tr>
                                ...
                                <td>
                                    <div class="form-group">
                                        <input type="text" class="form-control" name="prices[1][quantity]" value="">
                                    </div>
                                </td>
                                <td>
                                    <div class="form-group">
                                        <input type="text" class="form-control" name="prices[1][price]">
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <div class="form-group">
                                        <input type="text" class="form-control" name="prices[2][quantity]" value="">
                                    </div>
                                </td>
                                <td>
                                    <div class="form-group">
                                        <input type="text" class="form-control" name="prices[2][price]">
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <div class="form-group">
                                        <input type="text" class="form-control" name="prices[3][quantity]" value="">
                                    </div>
                                </td>
                                <td>
                                    <div class="form-group">
                                        <input type="text" class="form-control" name="prices[3][price]">
                                    </div>
                                </td>
                            </tr>
                        @elseif($loop->last && $loop->index == 1)
                            <tr>
                                <td>3.</td>
                                <td>
                                    <div class="form-group">
                        ...
                        @elseif($loop->last && $loop->index == 2)
                            <tr>
                                <td>4.</td>
                                <td>
                                    <div class="form-group">
                                        <input type="text" class="form-control" name="prices[4][quantity]" value="">
                                    </div>
                                </td>
                                <td>
                                    <div class="form-group">
                                        <input type="text" class="form-control" name="prices[4][price]">
                                    </div>
                                </td>
                            </tr>
                        @endif
                    @empty
                        <tr>
                            ...
                            <td>
                                <div class="form-group">
                                    <input type="text" class="form-control" name="prices[0][quantity]" value="">
                                </div>
                            </td>
                            <td>
                                <div class="form-group">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="form-group">
                                    <input type="text" class="form-control" name="prices[1][quantity]">
                                </div>
                            </td>
                            <td>
                                <div class="form-group">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="form-group">
                                    <input type="text" class="form-control" name="prices[2][quantity]">
                                </div>
                            </td>
                            <td>
                                <div class="form-group">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="form-group">
                                    <input type="text" class="form-control" name="prices[3][quantity]">
                                </div>
                            </td>
                            <td>
                                <div class="form-group">
...
<div id="variationModal" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">@lang('product.variation_values')</h4>
      </div>
      <div class="modal-body">
          <select class="form-control select2" id="selectVariationValues" multiple>
              
          </select>

             <button type="button" value="add" id="add_modal_button" class="btn btn-primary">@lang('messages.add')</button>
      </div>
...
<style type="text/css">
  ...
  #variationModal .select2-container{
    width: 500px;
    margin: 0 auto !important;
    display: block !important;
  }

 #variationModal .select2-container--default.select2-container--focus, #variationModal  .select2-container--default:active, #variationModal  .select2-container--default:focus,#variationModal  .select2-selection.select2-container--focus, #variationModal  .select2-selection:active, #variationModal  .select2-selection:focus{
    width: 500px;
    margin: 0 auto;
    display: block;
