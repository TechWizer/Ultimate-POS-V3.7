    ...
    @component('components.filters', ['title' => __('report.filters')])
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                {!! Form::select('manufacture_id', $manufactures, null, ['class' => 'form-control select2', 'style' => 'width:100%', 'id' => 'product_list_filter_manufacture_id', 'placeholder' => __('lang_v1.all')]); !!}
            </div>
        </div>
        <div class="col-md-3">
            <div class="form-group">
                {!! Form::label('type_id', 'Vehicle Type:') !!}
                {!! Form::select('type_id', $types, null, ['class' => 'form-control select2', 'style' => 'width:100%', 'id' => 'product_list_filter_type_id', 'placeholder' => __('lang_v1.all')]); !!}
            </div>
        </div>
        <div class="col-md-3">
            <div class="form-group">
                {!! Form::label('model_id', 'Vehicle Model:') !!}
                {!! Form::select('model_id', $models, null, ['class' => 'form-control select2', 'style' => 'width:100%', 'id' => 'product_list_filter_model_id', 'placeholder' => __('lang_v1.all')]); !!}
            </div>
        </div>
        <div class="col-md-3">
            <div class="form-group">
                {!! Form::label('compatible_models', 'Compatible Model:') !!}
                {!! Form::select('compatible_models', $models_comp, null, ['class' => 'form-control select2', 'style' => 'width:100%', 'id' => 'product_list_filter_compatible_models', 'placeholder' => __('lang_v1.all')]); !!}
            </div>
        </div>
...
<div class="modal fade" id="opening_stock_modal" tabindex="-1" role="dialog" 
    ...
    {{--        serial create modal--}}
    <div class="modal fade" id="serial-create-modal"></div><!-- /.modal -->
    <div class="modal fade" id="product-code-edit"></div><!-- /.modal -->
...
@section('javascript')
    ...
    <script type="text/javascript">
        $(document).ready( function(){
            product_table = $('#product_table').DataTable({
                ...
                "ajax": {
                    ...
                    "data": function ( d ) {
                        ...
                        d.manufacture_id = $('#product_list_filter_manufacture_id').val();
                        d.type_id = $('#product_list_filter_type_id').val();
                        d.model_id = $('#product_list_filter_model_id').val();
                        d.compatible_models = $('#product_list_filter_compatible_models').val();
                ...
                columns: [
                        {data: 'mass_delete'},
                        { data: 'image', name: 'products.image' , searchable: false},
                        ...
                        { data: 'type', name: 'products.type', searchable: false},
                        { data: 'category', name: 'c1.name' ,searchable: false},
                        { data: 'sub_category', name: 'c2.name' },
                        { data: 'brand', name: 'brands.name', searchable: false},
            ...
            $(document).on('change', '#product_list_filter_type, #product_list_filter_compatible_models, #product_list_filter_manufacture_id, #product_list_filter_model_id, #product_list_filter_type_id, #product_list_filter_category_id, #product_list_filter_brand_id, #product_list_filter_unit_id, #product_list_filter_tax_id, #location_id, #active_state, #repair_model_id', 
                function() {
    ...
    $(document).on('click', '#select-all-row', function () {
        if (this.checked){
            $('table#product_table tbody input.row-select').each(function () {
                if (!this.checked) {
                    $(this)
                        .prop('checked', true)
                        .change();
    ...
    $(document).on('click', '.add-product-code', function () {
        $('#product-code-edit').load($(this).data('href'), function () {
            $('#example1').DataTable();
            $('#product-code-edit').modal('show');
        })
    })
