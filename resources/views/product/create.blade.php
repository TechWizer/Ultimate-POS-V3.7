...
{!! Form::open(['url' => action('ProductController@store'), 'method' => 'post',
    ...
    @component('components.widget', ['class' => 'box-primary'])
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    {!! Form::text('second_name', !empty($duplicate_product->second_name) ? $duplicate_product->second_name : null, ['class' => 'form-control',
        ...
        <div class="col-sm-4">
          <div class="form-group">
            {!! Form::label('manufacture_id', 'Manufacture :') !!}
              {!! Form::select('manufacture_id', $manufactures, !empty($duplicate_product->manufacture_id) ? $duplicate_product->manufacture_id : null, ['placeholder' => __('messages.please_select'), 'class' => 'form-control select2']); !!}
          </div>
        </div>
        <div class="col-sm-4">
          <div class="form-group">
            {!! Form::label('type_id', 'Vehicle Type :') !!}
              {!! Form::select('type_id', $types, !empty($duplicate_product->type_id) ? $duplicate_product->type_id : null, ['placeholder' => __('messages.please_select'), 'class' => 'form-control select2']); !!}
          </div>
        </div>
        <div class="col-sm-4">
          <div class="form-group">
            {!! Form::label('vehicle_model_id', 'Vehicle Model :') !!}
              {!! Form::select('vehicle_model_id', $models, !empty($duplicate_product->vehicle_model_id) ? $duplicate_product->vehicle_model_id : null, ['placeholder' => __('messages.please_select'), 'class' => 'form-control select2']); !!}
          </div>
        </div>
        @php
        ...
        <div class="col-sm-4">
          <div class="form-group">
            {!! Form::label('compatible_models', 'Compatible With:') !!} 
              {!! Form::select('compatible_models[]', $models_comp, null, ['class' => 'form-control select2', 'multiple', 'id' => 'compatible_models']); !!}
          </div>
        </div>
            ...
            <div class="col-md-10">
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="form-group">
                                <input type="text" class="form-control" name="prices[0][quantity]">
                            </div>
                        </td>
                        <td>
                            <div class="form-group">
