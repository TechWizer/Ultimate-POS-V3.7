    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <br>
                  <label>
                    {!! Form::checkbox('pos_settings[enable_coin_points]', 1,  
                        !empty($pos_settings['enable_coin_points']) ? true : false , 
                    [ 'class' => 'input-icheck']); !!} {{ __( 'lang_v1.enable_coin_points' ) }} 
                  </label>
                  @show_tooltip(__('lang_v1.enable_coin_points_help'))
                </div>
            </div>
        </div>
