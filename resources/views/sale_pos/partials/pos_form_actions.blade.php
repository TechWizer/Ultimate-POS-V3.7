...
@if(isset($transaction))
	@include('sale_pos.partials.edit_discount_modal', ['sales_discount' => $transaction->discount_amount, 
		'discount_type' => $transaction->discount_type, 'rp_redeemed' => $transaction->rp_redeemed,
		'rp_redeemed_amount' => $transaction->rp_redeemed_amount, 
		'max_available' => !empty($redeem_details['points']) ? $redeem_details['points'] : 0,
		'coin_points_eared_amount' => $transaction->coin_points_earned_amount,
		'coin_points_redeemed_amount' => $transaction->coin_points_redeemed_amount,
		'coin_points_available' => !empty($reward_points_details['coin_points']) ? $reward_points_details['coinpoints'] : 0])
@else
	...
	'coin_points_eared_amount' => 0, 'coin_points_redeemed_amount' => 0, 'coin_points_available' => 0])
@endif
