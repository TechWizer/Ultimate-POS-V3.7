	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="row @if(empty($pos_settings['enable_coin_points'])) hide @endif">
					<div class="well well-sm bg-light-gray col-md-12">
						<div class="col-md-6">
				        <div class="form-group">
				            ...
				            <div class="input-group">
				                ...
				                {!! Form::number('coin_points_redeemed_amount_modal', $coin_points_redeemed_amount, ['class' => 'form-control direct_sell_coin_points_input', 'data-max_points' => $coin_points_available]); !!}
				                {{-- <input type="hidden" id="rp_name" value="{{session('business.rp_name')}}"> --}}
				            </div>
				        </div>
				    </div>
				    <div class="col-md-6">
				    	<p><strong>@lang('lang_v1.available_coin_points'):</strong> <span id="available_coin_points">{{ $coin_points_available }}</span></p>
				    </div>
					</div>
				</div>
			</div>
