	...
	<div class="modal-dialog" role="document">
		...
		<div class="col-md-6">
			<div class="form-group">
				...
				{!! Form::text("", null, ['class' => 'form-control', 'placeholder' => __('lang_v1.card_four_digits'), 'id' => "card_number", 'autofocus']); !!}
			</div>
		</div>
		<div class="col-md-6">
			<div class="form-group">
				{!! Form::label("card_holder_name", __('lang_v1.card_percentage')) !!}
				{!! Form::text("", "3", ['class' => 'form-control card_holder_name', 'placeholder' => __('lang_v1.card_percentage'), 'id' => "card_holder_name"]); !!}
			</div>
		</div>
{{--		<div class="col-md-4">--}}
{{--			<div class="form-group">--}}
