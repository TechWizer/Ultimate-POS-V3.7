		...
		<div class="form-group">
			...
			<div class="input-group">
              <span class="input-group-addon">
				...
				{!! Form::text('cheque_issued_date', @format_datetime(!empty($payment_line->cheque)?$payment_line->cheque->cheque_issued_date: now()), ['class' => 'form-control', 'required', 'id' => 'cheque_issued_date']); !!}
			</div>
		</div>
	</div>
	<div class="col-md-6">
