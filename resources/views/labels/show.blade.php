	...
	@component('components.widget', ['class' => 'box-primary', 'title' => __( 'barcode.info_in_labels' )])
		<div class="row">
			...
			<div class="col-sm-3">
				<div class="checkbox">
					<label>
						<input type="checkbox" checked name="print[sku]" value="1"> <b>SKU</b>
					</label>
				</div>
			</div>
			...
			<div class="col-sm-3">
				<div class="checkbox">
				    <label>
				    	<input type="checkbox" checked name="print[cost_code]" value="1"> <b>Cost Code</b>
				    </label>
				</div>
			</div>
			...
			<div class="col-sm-3">
				<div class="checkbox">
				    <label>
				    	<input type="checkbox" checked name="print[sell_code]" value="1"> <b>Price Code</b>
				    </label>
				</div>
			</div>
			...
			<div class="col-sm-3">
				<div class="checkbox">
					<label>
						<input type="checkbox" checked name="print[barcode]" value="1"> <b>Barcode</b>
					</label>
				</div>
			</div>
