...
return [
    ...
    'card_no' => 'Card Number',
    'card_four_digits' => 'Card Last 4 Digits',
    'card_percentage' => 'Card Payment Percentage',
   ...
   'payment_paid_notification' => 'Payment Paid Notification',
    ...
    'tooltip_cheque_alert' => "Cheque Alerts. <br/><small class='text-muted'>Based on cheque date. <br/> Showing cheques date to be issued/received in 7 days or less.</small>",
    ...
    'enable_coin_points' => 'Enable Coin Points',
    'enable_coin_points_help' => 'If this enabled, can add and redeemed coin points',
    'coin_points_redeemed' => 'Coin Points Redeemed',
    'available_coin_points' => 'Available Coin Points'
];
