...
class Product extends Model
{
    ...
    */
    ...
    {
        return $this->belongsTo(\App\Manufacture::class);
    }
    ...
    {
        return $this->belongsTo(\App\VehicleModel::class);
    }
    ...
    */
    ...
    public function product_quantity_discount_prices()
    {
        return $this->hasMany(ProductQuantityDiscountPrice::class);
    }
