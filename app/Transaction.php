...
class Transaction extends Model
{
    ...
    public function variation_location_serials_purchases()
    {
        return $this->hasMany(VariationLocationSerial::class, 'ref_no_transaction_id');
    }

    public function variation_location_serials_sells()
    {
        return $this->hasMany(VariationLocationSerial::class, 'invoice_no_transaction_id');
    }
