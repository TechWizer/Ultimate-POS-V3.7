...
class ReportController extends Controller
{
    ...
    public function getProfit($by = null)
    {
        ...
        WHERE tsl.parent_sell_line_id = transaction_sell_lines.id), IF(P.enable_stock=0, 
        (transaction_sell_lines.quantity - transaction_sell_lines.quantity_returned) * (transaction_sell_lines.unit_price_inc_tax - variations.dpp_inc_tax),   
