...
class PurchaseController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $transaction_data = $request->only([ 'ref_no', 'invoice_no', 'status', 'contact_id', 'transaction_date', 'total_before_tax', 'location_id','discount_type', 'discount_amount','tax_id', 'tax_amount', 'shipping_details', 'shipping_charges', 'final_total', 'additional_notes', 'exchange_rate', 'pay_term_number', 'pay_term_type']);
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            $update_data = $request->only([ 'ref_no', 'invoice_no', 'status', 'contact_id',
        ...
        try {
            if (request()->ajax()) {
                ...
                if ($transaction_status != 'received') {
                    ...
                    //                    deleting purchased purchase lines
                    $purchased_serials = $purchase_line->serials;
                    if (!empty($purchased_serials)){
    ...
    public function updateStatus(Request $request)
    {
        ...
        try {
            ...
            foreach ($transaction->purchase_lines as $purchase_line) {
                ...
                $this->productUtil->updateStockViaPurchaseStatus($before_status, $transaction, $purchase_line->product_id, $purchase_line->variation_id, $purchase_line->quantity, $purchase_line->quantity, $currency_details);
            }
