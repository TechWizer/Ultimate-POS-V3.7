...
class SellController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        if(!empty($pos_settings['enable_coin_points'])) {
            ...
            $reward_points_details['total_coins'] += $transaction->coin_points_redeemed_amount;
        ...
        return view('sell.edit')
            ->with(compact('business_details', 'taxes', 'sell_details', 'transaction', 'commission_agent', 'types', 'customer_groups', 'pos_settings', 'waiters', 'invoice_schemes', 'default_invoice_schemes', 'redeem_details', 'edit_discount', 'edit_price', 'accounts', 'shipping_statuses', 'warranties', 'reward_points_details'));
    }
